...
def macs2_peak_calling(sample_base, input_base):
    ...
    output_dir = '--outdir {}/peaks'.format(output_directory)  # Indicates the location of all output files
...
def homer_peak_calling(sample_base, peak_style):
    ...
    if peak_style == 'factor':
        ...
        quit()
    important_options = '-o {}/peaks/{0}/{0}_peaks.txt'.format(output_directory, sample_base)
